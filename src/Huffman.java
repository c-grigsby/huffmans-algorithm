...
public class Huffman {
	...
	public static void printCode(HuffmanNode root, String s)
	{
     ...
     String inputFile = "src/data220_example.txt";
     FileServices fs = new FileServices(inputFile);
     readFile(inputFile); //display
     System.out.println("=== Frequencies ================");
     int[] charfreq = fs.readFileForNumbers(); //get numbers
     int n = charfreq.length; //get number of chars
     System.out.println("\n=== Letters ================");
     char[] charArray = fs.readFileForLetters(); //get letters

     /*
 	 * Tree Author: Kunwar Desh Deepak Singh
 	 * Location: https://www.geeksforgeeks.org/huffman-coding-greedy-algo-3/
 	 */
   ...
   {
	 FileServices fs = new FileServices(fileName);
 	 String fileContents = "";
 	 try
 	 {
 	     fileContents = fs.readFile(); 
 	     System.out.println("\n=== File Contents ================\n");
 	  ...
 	  {
 	      System.out.println("Error. File was not found. "+ fnfe);
 	  }
 	  catch (IOException ioe)
 	  {
 		  System.out.println("Error. IOException has occured. "+ ioe);
 	  }
      catch (Exception e)
 	  {
    	  System.out.println("Unknown Error. Please try again. "+ e);
 	  }
 	 return fileContents; 
 	}
